This application is a simple counterapp using WatchKit, but the logic is written in Javascript; Telerik's NativeScript platform compiles the JavaScript into 
